...
class EndlessRecyclerViewScrollListener constructor(val layoutManager: RecyclerView.LayoutManager,
                                                    val loadMoreCallback: LoadMoreCallback) : RecyclerView.OnScrollListener() {
    ...
    override fun onScrolled(view: RecyclerView, dx: Int, dy: Int) {
        ...
        if (!loading && lastVisibleItemPosition + visibleThreshold > totalItemCount) {
            currentPage++
            loadMoreCallback.onLoadMore(currentPage, totalItemCount, view)
            loading = true
        }
    }
